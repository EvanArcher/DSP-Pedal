...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 24 12:24:47 2023
...
if __name__=='__main__':
    ...
    test_audio_file = os.path.join(parent_dir, 'IR_Files', 'My_vocals.wav')
    test_audio, test_audio_rate = sf.read(test_audio_file)
    
    sys.argv = ['Autotune_libraries.py', test_audio_file, '--plot', '--correction-method', 'stuff']

    pitch_corrected_y = main()
    sd.play(pitch_corrected_y, test_audio_rate)
    sd.wait()
